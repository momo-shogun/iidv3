...
export function MentorshipSection() {
  ...
  return (
    <section className="relative py-12 md:py-16 lg:py-20 bg-gradient-to-b from-slate-50 via-white to-white overflow-hidden">
      <div className="container max-w-7xl relative z-10 px-4 sm:px-6">
        ...
        >
          ...
          <Link
            to="/edp-programs"
            className="group flex items-center gap-2 text-xs md:text-sm font-medium text-slate-600 hover:text-[#004198] transition-colors min-h-[44px]"
          >
            View all programs
        ...
        >
          <div className="mx-auto max-w-2xl text-center mb-4 md:mb-6">
            <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-slate-900 mb-1">
          ...
          <div className="relative mx-auto flex h-40 sm:h-48 md:h-56 max-w-2xl items-center justify-center gap-2 sm:gap-3 md:gap-4 md:mt-12 mb-12 md:mb-20">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="h-full w-full max-w-[70px] sm:max-w-[90px] md:max-w-[120px]"
              >
                <BarChart {...stat} />
              </motion.div>
            ))}
          ...
          {programs.map((program, index) => (
            ...
            >
              ...
              >
                ...
                <div className={`relative h-28 md:h-36 bg-gradient-to-br ${program.gradient} p-4 md:p-5 overflow-hidden`}>
                  {/* Decorative Elements */}
                  <div className="absolute inset-0 opacity-20">
                    ...
                    <div className="absolute bottom-2 left-3 md:left-4 w-10 md:w-12 h-10 md:h-12 border border-white/20 rounded-full" />
                  </div>
                  <div className="relative">
                    <div className="flex items-start justify-between gap-2 md:gap-3 mb-2 md:mb-3">
                      <div className="w-10 h-10 md:w-12 md:h-12 bg-white/95 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      ...
                      <div className="px-2 md:px-3 py-0.5 md:py-1 bg-white/20 backdrop-blur-sm rounded-md border border-white/30">
                        <span className="text-[10px] md:text-xs font-semibold text-white">{program.duration}</span>
                      </div>
                    </div>
                ...
                <div className="p-4 md:p-5">
                  ...
                  <ul className="space-y-1.5 md:space-y-2 mb-4 md:mb-5">
                    {program.highlights.map((highlight) => (
                      <li key={highlight} className="flex items-start gap-1.5 md:gap-2 text-[10px] md:text-xs text-slate-700">
                        <CheckCircle className={`w-3 h-3 md:w-3.5 md:h-3.5 flex-shrink-0 mt-0.5 ${
                  ...
                  {/* CTA */}
                  <div className={`flex items-center gap-2 text-xs md:text-sm font-medium group-hover:gap-3 transition-all min-h-[44px] ${
                    program.accentColor === 'purple' ? 'text-purple-600' :
                    program.accentColor === 'teal' ? 'text-[#008F69]' :
                    'text-orange-600'
                  }`}>
